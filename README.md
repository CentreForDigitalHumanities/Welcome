...
## Quick start (CDH Employees)

Please note that membership of the CDH Github Organization is primarily reserved for members of the CDH and its affiliates. 
If you are otherwise connected to the Utrecht University, you are welcome to join the [Utrecht University Github organization](https://github.com/UtrechtUniversity). This will also grant you (limited) access to our organization. 
...
## Access for non-CDH personel

If you are in possession of a Solis-ID, you can join the [Utrecht University Github organization](https://github.com/UtrechtUniversity). This will also grant you (limited) access to our organization. 

In other cases, please contact us at [humanitiesit@uu.nl](mailto:humanitiesit@uu.nl) and we will find the best solution for you!
